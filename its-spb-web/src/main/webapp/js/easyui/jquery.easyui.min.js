...
(function ($) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        ...
        filter: function (q, row) {
            var opts = $(this).combobox("options");
            return row[opts.textField].indexOf($.trim(q)) > -1;
        },
...
(function ($) {
    function _891(_892) {
        ...
        function _895() {
            ...
            var _947 = $("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>").html(opts.cleanText).appendTo(_898);
            ...
            _947.click(function () {
                $(_892).combo("setValue", "").combo("setText", ""); //设置空值  
                $(_892).combo("hidePanel"); //点击清空按钮之后关闭日期选择面板 
            });
            _89a.click(function () {
                $(_892).combo("hidePanel");
            });
