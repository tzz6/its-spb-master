...
public class SysReportController {
	...
	public String index(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
		...
		modelMap.put("tableHeart", hearts);
	 ...
	 * @return
	 */
	@RequestMapping("/sysReportManage")
	public @ResponseBody
	Datagrid<Map<String, Object>> sysUserManage(HttpServletRequest request,
	 ...
	 * @return
	 */
	@RequestMapping("/sysReportPageValue")
