...
<!-- 		            	<select id="sr.sys_name_code" name="sr.sys_name_code" class="easyui-combobox" label="系统名:" labelPosition='top'  -->
...
// 							+ new Date().getTime(),
	...
	function querySysUserList() {
		$('#user_table').datagrid("options").url = '${apibase}/sysReport/sysReportManage?random='+ new Date().getTime();
